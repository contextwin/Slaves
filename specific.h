...
void MySpecicDrawMenue2Square(SDL_Renderer* render) {
 MySDLDrawSquare(render, 100, 550, 950, 800); //select_square2
 MySDLDrawSquare(render, 500, 50, 950, 500);  //view_square
}
